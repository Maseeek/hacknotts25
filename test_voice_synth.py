...
class VoiceSynthAgent:
    ...
    def get_voice_description(self, artist_name):
        ...
        prompt = f"""Describe the vocal characteristics of {artist_name} in detail for voice synthesis purposes. DO NOT include his name throught the whole output it. Include:
